...
const plans = [
  { title: "Free", price: "$0", duration: "/month", features: ["Basic AI assistance", "5 stories per month"], linkTo: "/signup", buttonLabel: "Get Started", highlight: false },
  { title: "Pro", price: "$19", duration: "/month", features: ["Unlimited stories", "Priority support"], linkTo: "/payment?plan=Pro&price=19", buttonLabel: "Start Pro Trial", highlight: true },
  { title: "Enterprise", price: "$49", duration: "/month", features: ["Team collaboration", "API access"], linkTo: "/contact-us", buttonLabel: "Contact Sales", highlight: false },
];
