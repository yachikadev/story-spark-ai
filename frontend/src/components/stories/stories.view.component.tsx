...
const StoriesViewComponent: React.FC<StoriesComponentProps> = ({
  ...
  const handleShareLink = async () => {
    ...
    setTimeout(() => { setIsLinkCopied(false); setIsShareOpen(false); }, 2000);
  };
                  ...
                  {isShareOpen && (
                    <>
                      ...
                      <div className="absolute left-0 top-full mt-2 z-20 w-44 bg-slate-800 border border-slate-700 rounded-xl shadow-xl overflow-hidden">
                        <button type="button" className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm font-semibold text-slate-200 hover:bg-slate-700 transition-colors cursor-pointer" onClick={handleShareLink}>
                          🔗 {isLinkCopied ? "✓ Copied!" : "Copy Link"}
                        </button>
                        <button type="button" className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm font-semibold text-slate-200 hover:bg-slate-700 transition-colors cursor-pointer" onClick={handleShareTwitter}>
                          𝕏 Share on X
                        </button>
                        <button type="button" className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm font-semibold text-slate-200 hover:bg-slate-700 transition-colors cursor-pointer" onClick={handleShareWhatsApp}>
                          💬 WhatsApp
                        </button>
                      </div>
                    </>
